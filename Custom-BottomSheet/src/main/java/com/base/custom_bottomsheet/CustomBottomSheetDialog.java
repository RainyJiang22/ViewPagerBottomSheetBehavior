...
import com.base.custom_bottomsheet.CustomBottomSheetBehavior.BottomSheetCallback;
...
public class CustomBottomSheetDialog extends AppCompatDialog {
    ...
    private FrameLayout ensureContainerAndBehavior() {
        if (container == null) {
            container =
                    (FrameLayout) View.inflate(getContext(), R.layout.design_custom_bottom_sheet_dialog, null);
    ...
    private static class EdgeToEdgeCallback extends BottomSheetCallback {
